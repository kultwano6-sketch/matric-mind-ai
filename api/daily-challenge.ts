// api/daily-challenge.ts - Daily challenges with pre-defined questions
...
const challenges = [
  ...
  { s: 'Life Sciences', q: 'What is the function of mitochondria?', o: { A: 'DNA storage', B: 'Protein synthesis', C: 'Energy production', D: 'Cell division' }, a: 'C', e: 'Mitochondria produce ATP' },
  ...
  { s: 'Economics', q: 'What is inflation?', o: { A: 'Decrease in prices', B: 'Rise in price levels', C: 'Increase in unemployment', D: 'Decrease in money supply' }, a: 'B', e: 'Inflation is rise in prices' },
  ...
  { s: 'Computer Applications Technology', q: 'What does CPU stand for?', o: { A: 'Central Processing Unit', B: 'Computer Personal Unit', C: 'Central Program Utility', D: 'Computer Processing Unit' }, a: 'A', e: 'CPU is brain of computer' },
  { s: 'Tourism', q: 'What is a passport used for?', o: { A: 'ID for voting', B: 'International travel', C: 'Bank verification', D: 'Driver license' }, a: 'B', e: 'Passport for travel' }
];
