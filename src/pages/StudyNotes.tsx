...
// Comprehensive study notes for all matric subjects aligned with DBE CAPS curriculum
const STUDY_NOTES: NoteTopic[] = [
  // Mathematics - Paper 1 & 2 breakdown per CAPS
  { id: 'math-patterns', subject: 'mathematics', topic: 'Patterns, Sequences & Series', description: 'Number patterns, arithmetic and geometric sequences, series.', keyPoints: ['Arithmetic sequence: T_n = a + (n-1)d', 'Geometric sequence: T_n = ar^(n-1)', 'Arithmetic series: S_n = n/2 × (2a + (n-1)d)', 'Geometric series: S_n = a(r^n - 1)/(r - 1) for r ≠ 1', 'Sigma notation: Σ (summation)', 'Finite vs infinite sequences'] },
  { id: 'math-functions', subject: 'mathematics', topic: 'Functions & Inverses', description: 'Defining functions, domain/range, inverse functions, and function operations.', keyPoints: ['Function: each input has exactly one output', 'Domain: set of all possible x-values', 'Range: set of all possible y-values', 'Inverse function: f⁻¹(x) exists if f is one-to-one', 'Composite functions: (f∘g)(x) = f(g(x))', 'Vertical line test for functions', 'Horizontal line test for one-to-one'] },
  { id: 'math-exponential', subject: 'mathematics', topic: 'Exponential & Logarithmic Functions', description: 'Exponential growth/decay, logarithmic functions, and their applications.', keyPoints: ['Exponential: f(x) = a·b^x', 'Logarithmic: f(x) = log_b(x) = y ↔ b^y = x', 'Log laws: log_b(xy) = log_b(x) + log_b(y)', 'Change of base: log_b(x) = ln(x)/ln(b)', 'pH calculations: pH = -log[H⁺]', 'Compound interest: A = P(1 + r/n)^(nt)', 'Exponential decay: N = N₀e^(-λt)'] },
  { id: 'math-finance', subject: 'mathematics', topic: 'Financial Mathematics', description: 'Simple/compound interest, annuities, loans, and investments.', keyPoints: ['Simple interest: I = P × r × t', 'Compound interest: A = P(1 + r/n)^(nt)', 'Future value of annuity: FV = PMT × [(1+r)^n - 1]/r', 'Present value: PV = FV/(1+r)^n', 'Loan repayments: amortisation schedules', 'Effective interest rate: (1 + r/n)^n - 1', 'Depreciation: straight-line and reducing balance'] },
  { id: 'math-geometry', subject: 'mathematics', topic: 'Analytical Geometry', description: 'Coordinate geometry, straight lines, circles, and transformations.', keyPoints: ['Distance formula: d = √((x₂-x₁)² + (y₂-y₁)²)', 'Midpoint: M((x₁+x₂)/2, (y₁+y₂)/2)', 'Gradient: m = (y₂-y₁)/(x₂-x₁)', 'Equation of line: y - y₁ = m(x - x₁)', 'Circle: (x - h)² + (y - k)² = r²', 'Tangent to circle: perpendicular to radius', 'Transformations: translation, reflection, rotation'] },
  { id: 'math-trig', subject: 'mathematics', topic: 'Trigonometry', description: 'Trigonometric ratios, identities, equations, and applications.', keyPoints: ['sin θ = opposite/hypotenuse, cos θ = adjacent/hypotenuse', 'tan θ = opposite/adjacent', 'Pythagoras: sin²θ + cos²θ = 1', 'Sine rule: a/sin A = b/sin B = c/sin C', 'Cosine rule: a² = b² + c² - 2bc·cos A', 'Area of triangle: ½ab·sin C', 'General solution: sin θ = k → θ = (-1)^n arcsin(k) + 180°n'] },
  { id: 'math-stats', subject: 'mathematics', topic: 'Statistics & Probability', description: 'Data analysis, probability distributions, and statistical inference.', keyPoints: ['Mean: Σx/n, Median: middle value, Mode: most frequent', 'Standard deviation: σ = √[Σ(x-μ)²/n]', 'Five-number summary: min, Q1, median, Q3, max', 'Normal distribution: 68-95-99.7 rule', 'P(A∪B) = P(A) + P(B) - P(A∩B)', 'P(A|B) = P(A∩B)/P(B)', 'Independent events: P(A∩B) = P(A) × P(B)'] },
  { id: 'math-euclidean', subject: 'mathematics', topic: 'Euclidean Geometry', description: 'Circle theorems, similarity, and geometric proofs.', keyPoints: ['Theorem of Pythagoras: a² + b² = c²', 'Circle theorems: angle at centre = 2 × angle at circumference', 'Angles subtended by same arc are equal', 'Opposite angles of cyclic quadrilateral sum to 180°', 'Tangent ⊥ radius at point of contact', 'Similar triangles: corresponding angles equal, sides proportional', 'Congruence: SSS, SAS, AAS, RHS tests'] },
